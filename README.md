...
| --- | --- | --- | --- |
| Cross$^\clubsuit$ | **$100.0$** | $11.6$ | $50.0$ |
| Cross+Self$^\clubsuit$  | $99.7$ | $86.9$ | $50.0$ |
| FactorCL$^\clubsuit$ | $99.8$ | $62.5$ | $46.5$ |
| MAE | $99.8_{\pm0.11}$ | $82.4_{\pm3.09}$ | $50.1_{\pm0.24}$ |
| CoMM | $99.9_{\pm0.06}$ | $86.8_{\pm2.99}$ | $71.4_{\pm3.47}$ |
| InfMasking (ours) | $99.9_{\pm0.09}$ | **$90.6_{\pm2.31}$** | **$77.0_{\pm4.22}$** |
...
| --- | --- | --- | --- | --- | --- | --- |
| Cross$^\clubsuit$  | $33.09_{\pm3.67}$ | $66.7_{\pm0.1}$ | $47.8_{\pm1.8}$ | $50.1_{\pm1.9}$ | $53.5_{\pm2.9}$ | $54.52$ |
| Cross+Self$^\clubsuit$  | $7.56_{\pm0.31}$ | $65.49_{\pm0.0}$ | $49.0_{\pm1.1}$ | $59.9_{\pm0.9}$ | $53.9_{\pm4.0}$ | $57.07$ |
| FactorCL$^\clubsuit$  | $10.82_{\pm0.56}$ | $67.3_{\pm0.0}$ | $51.2_{\pm1.6}$ | $60.5_{\pm0.8}$ | $55.80_{\pm0.9}$ | $58.7$ |
| CoMM  | $7.96_{\pm2.13}$ | $66.4_{\pm0.41}$ | $63.7_{\pm2.5}$ | $63.3_{\pm0.51}$ | $64.4_{\pm1.1}$ | $64.45$ |
| InfMasking (ours) | **$4.23_{\pm0.37}$** | **$68.1_{\pm0.42}$** | **$69.0_{\pm1.2}$** | **$64.3_{\pm0.9}$** | **$66.8_{\pm2.5}$** | **$67.05$** |
...
|---------------|-------|---------------|----------------|
| Cross         | 2     | $86.3_{\pm0.25}$ | $50.1^\clubsuit$ |
| Cross+Self    | 2     | $87.6_{\pm0.26}$ | $59.9^\clubsuit$ |
| CoMM          | 2     | $85.3_{\pm0.84}$ | $63.3_{\pm0.51}$  |
| InfMasking (ours) | 2     | $88.5_{\pm0.33}$ | $64.3_{\pm0.9}$   |
| CMC$^\clubsuit$ | 3     | $94.1$          | $59.2$           |
| CoMM          | 3     | **$94.1_{\pm0.17}$** | $64.8_{\pm1.13}$  |
| InfMasking (ours) | 3     | $94.1_{\pm0.09}$ | **$65.6_{\pm1.15}$**  |
...
|------------------------------|------------|----------------|----------------|
| SimCLR$^{\clubsuit\triangle}$  | V          | $40.35_{\pm0.23}$ | $27.99_{\pm0.33}$ |
|                              | V          | $51.5$           | $40.8$           |
| CLIP$^\clubsuit$      | L          | $51.0$           | $43.0 $          |
|                              | V+L        | $58.9_{\pm0.0}$ | $50.9_{\pm0.0}$ |
| SLIP$^{\clubsuit\triangle}$  | V+L        | $56.54_{\pm0.19}$ | $47.35_{\pm0.27}$ |
| CLIP$^{\clubsuit\triangle}$  | V+L        | $54.49_{\pm0.19}$ | $44.94_{\pm0.30}$ |
| CoMM$_{\text{(CLIP backbone)}}$   | V+L        | $61.29_{\pm0.73}$ | $53.79_{\pm0.22}$ |
| InfMasking$_{\text{(ours, CLIP backbone)}}$ | V+L | **$62.60_{\pm0.26}$** | **$55.93_{\pm0.19}$** |
